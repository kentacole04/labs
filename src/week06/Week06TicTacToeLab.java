...
public class Week06TicTacToeLab {
	...
	public static void main(String[] args) {
		...
		while(!result) {
			System.out.print("Player 1, choose a space 1-9");
			myGame.playMove('X', sc.nextInt());
			if (myGame.checkWinStatus() == true) {
				break;
			}
			System.out.print("Player 2, choose a space 1-9");
			myGame.playMove('O', sc.nextInt());
			if (myGame.checkWinStatus() == true) {
				break;
			}
